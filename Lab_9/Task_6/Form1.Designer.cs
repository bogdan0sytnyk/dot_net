...
namespace Task_6
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Ціна телефону:";
            // 
            // label3
            // 
            ...
            // Додаємо кнопку для конвертації валюти
            System.Windows.Forms.Button button2;
            button2 = new System.Windows.Forms.Button();
            button2.Location = new System.Drawing.Point(76, 154);
            button2.Name = "button2";
            button2.Size = new System.Drawing.Size(55, 24);
            button2.Text = "$";
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            label2.Text = "Ціна телефону:" + phonePrice;
        ...
        {
            double usdExchangeRate = 0.027; // Курс гривні до долара
            ...
            double total = phonePrice + selectedAccessoriesPrice;
            double totalUSD = total * usdExchangeRate;
            double discount = 0;
            ...
            double finalPrice = total - discount;
            double finalPriceUSD = finalPrice * usdExchangeRate;

            label2.Text = "Ціна телефону: $" + phonePrice * usdExchangeRate;
            label3.Text = "Ціна телефону в комплекті: $" + totalUSD;
            label4.Text = "Ціна на інше: $" + selectedAccessoriesPrice * usdExchangeRate;
            label5.Text = "Знижка: $" + discount * usdExchangeRate;
            label6.Text = "Разом: $" + finalPriceUSD;
        }
